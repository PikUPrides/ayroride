...
const testimonials = [
    ...
    {
        quote: "I've been frustrated with surge pricing for years. PikUP's referral program not only rewards me financially but lets me be part of the solution. It feels great knowing I'm helping create fairer ride-sharing.",
        author: "Michael J."
    },
    {
    ...
    {
        quote: "As a driver-turned-rider, I appreciate that PikUP treats both sides fairly. It's a win-win that actually feels genuine.",
        author: "Amanda R."
    }
];
