                ...
                <div className={styles.whyContent}>
                    <div className={styles.contentWrapper}>
                        ...
                        <p className={styles.whySubtitle}>
                            ...
                            AYRO keeps it simple, safe, and affordable.
                        </p>
                ...
                <div className={styles.safetyContainer}>
                    ...
                    <div className={styles.safetyGrid}>
                        <div className={styles.safetyItem}>
                            ...
                            <p>
                                Every driver is verified before joining the <br /> platform.
                            </p>
                        </div>
                        <div className={styles.safetyItem}>
                            <Image
                            ...
                            <p>
                                Emergency support and trip sharing are <br /> built directly into the app.
                            </p>
                        </div>
                        <div className={styles.safetyItem}>
                            <Image
                            ...
                            <h3>Trip Tracking</h3>
                            <p>
                                We monitor your ride from pickup to drop- <br /> off with clear trip records and accountability.
                            </p>
                        </div>
                    </div>
                </div>
