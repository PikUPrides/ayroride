          ...
          <div className={styles.infoTextSide}>
            ...
            <div className={styles.socialSection}>
              ...
              <div className={styles.socialIcons}>
                ...
                <a href="https://www.facebook.com/AYRORides" target="_blank" className={styles.socialIcon}>
                  <Image src="/assets/facebook-icon.png" alt="Facebook" width={32} height={32} />
                </a>

                <a href="https://x.com/ayrorides" target="_blank" className={styles.socialIcon}>
                ...
                <a href="https://www.youtube.com/@AYROrides" target="_blank" className={`${styles.socialIcon} ${styles.youtubeIcon}`}>
