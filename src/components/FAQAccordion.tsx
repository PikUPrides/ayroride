...
const faqData = [
  {
    ...
    answer:
      "Sign up to receive your unique link, then share it with friends. You'll earn rewards as people join through your link, with increasing prizes at 10, 25, and 50 referrals.",
  },
  {
    question: "What rewards can I earn?",
    answer:
      "Rewards include cash payments up to $1,000, ride credits for future use, and entry into our MacBook Pro giveaway when you reach the highest tier.",
  },
  {
    question: "When will I receive my rewards?",
    answer:
      "Rewards are distributed automatically when you reach each tier threshold. You'll receive notification and can track your progress on your personal dashboard.",
  },
  {
    question: "Is there a deadline to participate?",
    answer:
      "The referral program is available to early adopters for a limited time. Join now to maximize your earning potential and secure your early adopter status.",
  },
  {
    question: "How does AYRO eliminate surge pricing?",
    answer:
      "Our model creates predictable pricing by building a large user base first, then launching with transparent fares that fairly compensate drivers without exploiting riders during peak times.",
  },
];
