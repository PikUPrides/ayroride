...
export const jobs: JobPosting[] = [
    {
        ...
        description: "Drive with AYRO in Dallas, TX. Earn guaranteed $30+ per Active Hour, no surge pricing, flexible schedule, and real human support.",
    ...
    },
    {
        ...
        experience: "2 Years",
        type: "Full time, part time, gig workers",
        description: "Join AYRO as a driver in Arlington, TX. Earn $30+ per Active Hour, choose your hours, no surge pricing, and driver-first pay.",
        salary: "$30+/ Active Hour (guaranteed)",
